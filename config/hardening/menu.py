...
class Display_Menu:
		...
		# Verification Functions
                ...
                self.window.set_title("Red Hat Enterprise Linux 6 - SSG Installation")
		...
		self.label = gtk.Label('using the SCAP Security Guide (SSG) as a hardening script.                  RHEL 6 (SSG DVD Installer v.1.0)')
                self.vbox.add(self.label)
